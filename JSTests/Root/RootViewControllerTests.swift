...
struct RootViewControllerTests {
    ...
    func viewDidLoad() throws {
        ...
        #expect(subject.toolbar.items?.count == 11)
        ...
        #expect(items[9].width == 30)
        #expect(items[0].image == UIImage(named: "Key"))
        #expect(items[0].target === subject)
        #expect(items[0].action == #selector(subject.toggleEnglish))
        #expect(items[2].image == UIImage(named: "speechbubble"))
        #expect(items[2].target === subject)
        #expect(items[2].action == #selector(subject.toggleExtraInfo))
        #expect(items[4].image == UIImage(named: "folder"))
        #expect(items[4].target === subject)
        #expect(items[4].action == #selector(subject.showLessonList))
        #expect(items[6].image == UIImage(named: "magnifier"))
        #expect(items[6].target === subject)
        #expect(items[6].action == #selector(subject.showAllTermsList))
        #expect(items[8].image == UIImage(named: "bulb"))
        #expect(items[8].target === subject)
        #expect(items[8].action == #selector(subject.showLessonListDrill))
